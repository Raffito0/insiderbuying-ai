...
Generate content for section `section-00-schema-migration` (filename: `section-00-schema-migration.md`).
...
for `section-00-schema-migration` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\04-sec-alerts-system/sections/section-00-schema-migration.md`
