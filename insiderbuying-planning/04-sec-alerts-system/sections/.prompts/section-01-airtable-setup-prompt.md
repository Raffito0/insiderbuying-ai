...
Generate content for section `section-01-airtable-setup` (filename: `section-01-airtable-setup.md`).
...
for `section-01-airtable-setup` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\04-sec-alerts-system/sections/section-01-airtable-setup.md`
