...
Generate content for section `section-03-score-alert` (filename: `section-03-score-alert.md`).
...
for `section-03-score-alert` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\04-sec-alerts-system/sections/section-03-score-alert.md`
