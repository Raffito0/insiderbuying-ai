...
Generate content for section `section-04-analyze-alert` (filename: `section-04-analyze-alert.md`).
...
for `section-04-analyze-alert` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\04-sec-alerts-system/sections/section-04-analyze-alert.md`
