...
Generate content for section `section-03-social-pipeline` (filename: `section-03-social-pipeline.md`).
...
for `section-03-social-pipeline` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\08-nocodb-migration/sections/section-03-social-pipeline.md`
