...
Generate content for section `section-03-transaction-classification` (filename: `section-03-transaction-classification.md`).
...
for `section-03-transaction-classification` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\09-data-pipeline/sections/section-03-transaction-classification.md`
