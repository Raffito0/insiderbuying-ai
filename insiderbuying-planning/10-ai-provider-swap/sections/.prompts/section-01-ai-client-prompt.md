...
Generate content for section `section-01-ai-client` (filename: `section-01-ai-client.md`).
...
for `section-01-ai-client` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/sections/section-01-ai-client.md`
