...
Generate content for section `section-03-migrate-generate-article` (filename: `section-03-migrate-generate-article.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/claude-plan.md` - Full implementation plan
2. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-migrate-generate-article` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/sections/section-03-migrate-generate-article.md`
