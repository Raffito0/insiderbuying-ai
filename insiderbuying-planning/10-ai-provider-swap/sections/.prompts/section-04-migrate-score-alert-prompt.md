...
Generate content for section `section-04-migrate-score-alert` (filename: `section-04-migrate-score-alert.md`).
...
for `section-04-migrate-score-alert` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/sections/section-04-migrate-score-alert.md`
