...
Generate content for section `section-05-migrate-analyze-alert` (filename: `section-05-migrate-analyze-alert.md`).
...
for `section-05-migrate-analyze-alert` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\10-ai-provider-swap/sections/section-05-migrate-analyze-alert.md`
