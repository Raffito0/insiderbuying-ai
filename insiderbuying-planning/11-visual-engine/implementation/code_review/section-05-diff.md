diff --git a/ryan_cole/insiderbuying-site/n8n/code/insiderbuying/report-covers.js b/ryan_cole/insiderbuying-site/n8n/code/insiderbuying/report-covers.js
new file mode 100644
index 0000000..404fb8d
--- /dev/null
+++ b/ryan_cole/insiderbuying-site/n8n/code/insiderbuying/report-covers.js
@@ -0,0 +1,311 @@
+'use strict';
+
...
+    ? `<img src="${escapeHtml(String(data.logoUrl))}" style="width:48px;height:48px;border-radius:8px;object-fit:contain;" />`
...
+  const viewport = { width: 1240, height: 1754, deviceScaleFactor: 2 };
+  const buffer = await takeScreenshot(html, viewport, helpers);
+  return uploadChart(buffer, `cover-b-${sectorName.toLowerCase().replace(/\s+/g, '-')}`, helpers);
+}
+
...
diff --git a/ryan_cole/insiderbuying-site/tests/insiderbuying/report-covers.test.js b/ryan_cole/insiderbuying-site/tests/insiderbuying/report-covers.test.js
new file mode 100644
index 0000000..573f772
--- /dev/null
+++ b/ryan_cole/insiderbuying-site/tests/insiderbuying/report-covers.test.js
@@ -0,0 +1,245 @@
+'use strict';
+
