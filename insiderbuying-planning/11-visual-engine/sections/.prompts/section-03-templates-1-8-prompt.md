...
Generate content for section `section-03-templates-1-8` (filename: `section-03-templates-1-8.md`).
...
for `section-03-templates-1-8` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\11-visual-engine/sections/section-03-templates-1-8.md`
