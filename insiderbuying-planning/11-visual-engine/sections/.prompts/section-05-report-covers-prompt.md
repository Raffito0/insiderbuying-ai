...
Generate content for section `section-05-report-covers` (filename: `section-05-report-covers.md`).
...
for `section-05-report-covers` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\11-visual-engine/sections/section-05-report-covers.md`
