...
Generate content for section `section-07-identity-photos` (filename: `section-07-identity-photos.md`).
...
for `section-07-identity-photos` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\11-visual-engine/sections/section-07-identity-photos.md`
