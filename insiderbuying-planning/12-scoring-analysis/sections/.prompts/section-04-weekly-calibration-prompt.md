...
Generate content for section `section-04-weekly-calibration` (filename: `section-04-weekly-calibration.md`).
...
for `section-04-weekly-calibration` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\12-scoring-analysis/sections/section-04-weekly-calibration.md`
