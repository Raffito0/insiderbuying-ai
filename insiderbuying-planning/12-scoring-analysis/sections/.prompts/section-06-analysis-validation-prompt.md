...
Generate content for section `section-06-analysis-validation` (filename: `section-06-analysis-validation.md`).
...
for `section-06-analysis-validation` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\12-scoring-analysis/sections/section-06-analysis-validation.md`
