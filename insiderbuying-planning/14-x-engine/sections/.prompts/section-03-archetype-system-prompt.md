...
Generate content for section `section-03-archetype-system` (filename: `section-03-archetype-system.md`).
...
for `section-03-archetype-system` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\14-x-engine/sections/section-03-archetype-system.md`
