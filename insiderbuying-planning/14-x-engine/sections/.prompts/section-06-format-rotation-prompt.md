...
Generate content for section `section-06-format-rotation` (filename: `section-06-format-rotation.md`).
...
for `section-06-format-rotation` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\14-x-engine/sections/section-06-format-rotation.md`
