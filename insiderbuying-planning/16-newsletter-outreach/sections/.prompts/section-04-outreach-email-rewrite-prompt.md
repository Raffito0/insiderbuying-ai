...
Generate content for section `section-04-outreach-email-rewrite` (filename: `section-04-outreach-email-rewrite.md`).
...
for `section-04-outreach-email-rewrite` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\16-newsletter-outreach/sections/section-04-outreach-email-rewrite.md`
