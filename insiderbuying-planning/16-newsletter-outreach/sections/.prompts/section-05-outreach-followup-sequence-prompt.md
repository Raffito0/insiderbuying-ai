...
Generate content for section `section-05-outreach-followup-sequence` (filename: `section-05-outreach-followup-sequence.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\16-newsletter-outreach/claude-plan.md` - Full implementation plan
2. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\16-newsletter-outreach/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\16-newsletter-outreach/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-outreach-followup-sequence` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\16-newsletter-outreach/sections/section-05-outreach-followup-sequence.md`
