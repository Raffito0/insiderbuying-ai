...
Generate content for section `section-02-seo-tool-swap` (filename: `section-02-seo-tool-swap.md`).
...
for `section-02-seo-tool-swap` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/sections/section-02-seo-tool-swap.md`
