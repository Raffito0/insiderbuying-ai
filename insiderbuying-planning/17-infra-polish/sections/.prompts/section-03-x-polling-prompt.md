...
Generate content for section `section-03-x-polling` (filename: `section-03-x-polling.md`).
...
for `section-03-x-polling` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/sections/section-03-x-polling.md`
