...
Generate content for section `section-04-hero-image-swap` (filename: `section-04-hero-image-swap.md`).
...
for `section-04-hero-image-swap` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/sections/section-04-hero-image-swap.md`
