...
Generate content for section `section-04-hero-image-visual-templates` (filename: `section-04-hero-image-visual-templates.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/claude-plan.md` - Full implementation plan
2. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-hero-image-visual-templates` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\17-infra-polish/sections/section-04-hero-image-visual-templates.md`
