...
Generate content for section `section-05-infra-fixes` (filename: `section-05-infra-fixes.md`).
...
for `section-05-infra-fixes` to understand what this section should contain.
