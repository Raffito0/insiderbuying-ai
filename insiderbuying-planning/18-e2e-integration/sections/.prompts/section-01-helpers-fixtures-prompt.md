...
Generate content for section `section-01-helpers-fixtures` (filename: `section-01-helpers-fixtures.md`).
...
for `section-01-helpers-fixtures` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\18-e2e-integration/sections/section-01-helpers-fixtures.md`
