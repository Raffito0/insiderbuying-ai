...
Generate content for section `section-02-jest-config` (filename: `section-02-jest-config.md`).
...
for `section-02-jest-config` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\18-e2e-integration/sections/section-02-jest-config.md`
