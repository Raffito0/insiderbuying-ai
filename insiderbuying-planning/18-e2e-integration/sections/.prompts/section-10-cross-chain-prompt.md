...
Generate content for section `section-10-cross-chain` (filename: `section-10-cross-chain.md`).
...
for `section-10-cross-chain` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\ryan_cole\insiderbuying-planning\18-e2e-integration/sections/section-10-cross-chain.md`
