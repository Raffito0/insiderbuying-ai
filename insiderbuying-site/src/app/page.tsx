  ...
  return (
    <div className="bg-white">
      ...
      <section className="w-full py-[24px] bg-white overflow-hidden" aria-hidden="true">
        ...
        <style>{`@keyframes scroll{from{transform:translateX(0)}to{transform:translateX(-50%)}}.logo-ticker{animation:scroll 60s linear infinite}@media(max-width:768px){.logo-ticker{animation-duration:100s}}`}</style>
      </section>
