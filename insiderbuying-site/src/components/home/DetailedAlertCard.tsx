        ...
        <div className="bg-white rounded-xl border border-[var(--color-border)] shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 border-b md:border-b-0 md:border-r border-[var(--color-border-light)]">
              <p className="text-xs font-semibold uppercase tracking-widest text-[var(--color-muted)] mb-6">
                Transaction Data
              </p>

              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg bg-[var(--color-bg-alt)] flex items-center justify-center text-xs font-bold text-[var(--color-muted)]">
                  NVDA
                </div>
                <div>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex justify-between">
                  <span className="text-[var(--color-muted)]">Insider</span>
                  <span className="font-medium">Jensen Huang, CEO</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[var(--color-muted)]">Amount</span>
                  <span className="font-bold font-[var(--font-mono)] text-[var(--color-accent-green)]">
                    $2,298,580
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-[var(--color-muted)]">Shares</span>
                  <span className="font-[var(--font-mono)]">20,450</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[var(--color-muted)]">Filed</span>
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="inline-block text-[10px] font-bold uppercase px-3 py-1 rounded-full bg-[var(--color-accent-green)]/10 text-[var(--color-accent-green)]">
                  High Conviction
                </span>
              </div>
              ...
              <div className="space-y-4 text-sm text-[var(--color-muted)] leading-relaxed">
                <div>
                  <span className="font-semibold text-[var(--color-text)]">Context: </span>
                  Largest CEO purchase since Q2 2024. Previous buy at $78 preceded
                  a 47% rally within 3 months.
                </div>
                <div>
                  <span className="font-semibold text-[var(--color-text)]">Historical: </span>
              ...
              <div className="mt-6 p-4 rounded-lg bg-[var(--color-bg-alt)]">
                <div className="flex justify-between text-xs mb-2">
                  <span className="text-[var(--color-muted)]">Conviction Score</span>
                  <span className="font-bold font-[var(--font-mono)] text-[var(--color-accent-green)]">
                    92/100
                  </span>
                </div>
